...
class Health: UIView {
    ...
    var filterArray :[String] = ["Consulting","Surgery","Surgery","Medical analysis","Radiography and medical imagery"] {
        didSet{
...
extension Health :  UICollectionViewDataSource {
...
extension Health : UICollectionViewDelegate{
