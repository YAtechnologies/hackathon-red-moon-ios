...
class artisanalMarket: UIView {
    
    //TODO: This need to be changed, it is copied for reference...
    var filterArray :[String] = ["Oils and extracts","Fresh and dried produce","Hygiene and beauty","Interior decoration","Clothes and fabrics", "Pottery and Houseware", "Pottery and Houseware"] {
        didSet{
...
extension artisanalMarket :  UICollectionViewDataSource {
...
extension artisanalMarket : UICollectionViewDelegate{
