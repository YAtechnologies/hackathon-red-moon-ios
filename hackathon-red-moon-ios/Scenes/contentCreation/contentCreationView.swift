...
class contentCreationView: UIView {
    
    //TODO: This need to be changed, it is copied for reference...
    
    var filterArray :[String] = ["Video editing","Composing and soundtracks","Voice-over","Visual effects and animations"] {
        didSet{
...
extension contentCreationView :  UICollectionViewDataSource {
...
extension contentCreationView : UICollectionViewDelegate{
