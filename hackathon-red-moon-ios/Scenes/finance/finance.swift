...
class finance: UIView {
    
   
    
    //TODO: This need to be changed, it is copied for reference...
    var filterArray :[String] = ["Accounting and bookkeeping"," Advice","Audit"] {
        didSet{
...
extension finance :  UICollectionViewDataSource {
...
extension finance : UICollectionViewDelegate{
