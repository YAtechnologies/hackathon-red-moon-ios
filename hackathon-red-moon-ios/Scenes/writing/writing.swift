...
class writing: UIView {
    ...
    var filterArray :[String] = ["Proofreading","Translation","Article creation","Content layout design"] {
        didSet{
...
extension writing :  UICollectionViewDataSource {
...
extension writing : UICollectionViewDelegate{
